defmodule Pensieve.HogwartsTest do
  ...
  describe "wizards" do
    ...
    test "create_wizard/1 with valid data creates a wizard" do
      valid_attrs = %{first_name: "some first_name", last_name: "some last_name", house: "some house", points: "some points"}
      ...
      assert wizard.points == "some points"
    end
    ...
    test "update_wizard/2 with valid data updates the wizard" do
      wizard = wizard_fixture()
      update_attrs = %{first_name: "some updated first_name", last_name: "some updated last_name", house: "some updated house", points: "some updated points"}
      ...
      assert wizard.points == "some updated points"
    end
